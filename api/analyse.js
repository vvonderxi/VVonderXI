...
STATE THE RECORDED FIGURES. Do NOT read a judgement of any kind off the VV Score for that card , not defending, not attacking, not overall, not "the Index rates him", not "a 74 season". The number may be named as a placement on the ladder; it may not be explained, justified or attributed to how he played. THIS IS THE SAME RULE AS THE KEEPER CONTRACT AND FOR THE SAME REASON: prose must not assert through description what the platform refuses to assert through measurement.
