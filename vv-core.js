...
(function (root) {
  ...
  function buildCard(d, cw){
    ...
    return `<div class="vvcard" style="--cw:${cw}px">
      ...
      ${tag}
      <div class="cga"><div class="col"><div class="v">${d.goals}</div><div class="l">Goals</div></div><div class="divider"></div><div class="col"><div class="v">${d.assists != null ? d.assists : '—'}</div><div class="l">Assists</div></div></div>
