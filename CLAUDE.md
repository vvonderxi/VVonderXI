...
1. **TAG KEYSTONE , ~DONE (verified 2026-07-19).** [DONE] tag distribution validated + eligibility() 8-bucket fix (16360ba, The Winger 78->790); honours team-join (bf1b0fa, 2992 cards gain Silverware, league_champion/ucl_winner now attach); filter+picker vocab reconciliation from ONE FILTER_TAXONOMY in vv-core (6397086, 18 invented chips killed, dead filters made live). [OPEN , closes Step 1] the playbook GLOSSARY still advertises orphan tags the engine never emits (Talisman, Pace Merchant, Target Man, False Nine, Deep-Lying Playmaker, Elite Keeper) , the vocab fix hit the FILTER chips, NOT the playbook prose. De-orphan the glossary.
