...
- NEXT: scope the Delap-class importer stat-block fix (multi-block prevalence, bias, max-minutes correctness incl. the parked mid-season-transfer dual-card decision) + the insert-only rt-safe re-ingest.
